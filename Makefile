...
EXECUTOR = $(EXE_DIR)/pipes.c $(EXE_DIR)/execute.c $(EXE_DIR)/execute_utils.c $(EXE_DIR)/env.c $(EXE_DIR)/env_utils.c $(EXE_DIR)/path.c $(EXE_DIR)/heredoc.c
...
UTILS = $(UTILS_DIR)/utils_random.c $(UTILS_DIR)/signals.c $(UTILS_DIR)/freemem/parse_free.c $(UTILS_DIR)/freemem/free_token.c $(UTILS_DIR)/freemem/builtin_free.c $(UTILS_DIR)/prints/banner.c $(UTILS_DIR)/prints/tokens.c $(UTILS_DIR)/prints/parser.c $(UTILS_DIR)/prints/errors.c
